...
def ui_filtrarea_cheltuielilor_cu_suma_mai_mica_sumap(context):
    ...
    subsir = filtrarea_cheltuielilor_cu_suma_mai_mica_sumap(lista_cheltuieli,suma)
    print(subsir)
...
def run():
    ...
    comenzi_modificare = {
        ...
        "sorteaza_lista_dupa_tip": ui_sortare_lista_cheltuieli_dupa_tip,
        "undo": ui_undo,
    }
    comenzi_afisare = {
        "afiseaza_cheltuielile_mai_mari_decat_o_suma": ui_cheltuieli_mai_mari_decat_sumap,
        "afiseaza_cheltuielile_mai_mici_decat_o_suma_inainte_de_o_zii": ui_cheltuieli_mai_mici_sumap_inainte_ziuap,
        "afiseaza_cheltuielile_cu_tipul_dat": ui_cheltuieli_dupa_tip,
        ...
        "afiseaza_cheltuielile_care_au_suma_egala_cu_una_data": ui_cheltuiala_cu_sumap,
